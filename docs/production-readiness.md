...
- [ ] **Email delivery for developer invites** (set-password link) and admin notifications. No email provider exists yet; the developer-onboarding step depends on it.
