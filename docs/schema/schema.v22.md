# Schema v22 — anonymous analytics events, and anonymise-not-delete

**Date:** 2026-09-26. **Migration:** `0027_analytics_anonymous_events`. **Owner answers:** in chat, 2026-09-26 (`DECISIONS.md` the same date). **Tasklist:** `docs/tasklists/2026-09-26-anonymous-events-and-retention.md`. **Builds on:** `docs/schema/schema.v20.md` (and sits after Deep's [v21](schema.v21.md), which is unrelated: it adds released developer analytics and changes nothing here)
**Builds on:** [schema v20](schema.v20.md), whose text is unchanged; this document supersedes its retention and identity rules. Unrelated to [v21](schema.v21.md), which adds released developer analytics and changes nothing here.
**Renumbered:** proposed as v21 with migration `0025` on 2026-09-26, renumbered on merge because Deep's Phase 4 branch was pushed first and had already taken v21, `0025` and `0026` (`AGENTS.md`: whoever merges second renumbers).
