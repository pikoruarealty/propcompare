...
| Method and route                           | Status                     | Access                 | Contract                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ------------------------------------------ | -------------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `GET /api/v1/developer/portfolio`          | Implemented (2026-09-26)   | Developer staff        | `?window=` one of `7d`, `30d`, `qtd`, `ytd`, `12m` (default `30d`; anything else, including a date range or a developer id, is `422`). The signed-in developer's own listed properties: the portfolio's `visitors`, `visits` and `returningVisitors`, and per property its eleven released figures and its `completeness` (`{ stated, total }`, the dossier's own "facts stated"). Every figure is `{ released, value }`; a withheld one has `released: false` and `value: null`, never zero. `meta` carries `window`, `generatedAt`, `trackingSince`, `coverage` (`full`, `partial`, `none`), `minVisitors`, `rulesVersion` and `stale`, and is `null` before the first release. `private, no-store`. No visitor or session id, price, buyer detail or enquiry figure.                                                                                                                                                                                                                                                                                         |
| `GET /api/v1/developer/properties/{id}`    | Implemented (2026-09-26)   | Developer staff        | The same `window`. One of the developer's own listed properties: `figures`, the counted `splits` (visitors by budget band, device, intake BHK and intake city; viewers by budget band and device; comparers by budget band; a split appears only where something was counted). An intake split links the same identified visitor's earlier stated choice to a later direct view or comparison of this property in the window, then applies the five-visitor and no-subtraction gates (`schema.v24.md`); it is not a market-wide figure. Also `rivals` (at most five listed properties opened in a comparison beside it by at least 5 identified visitors: `{ property, developerName, own, visitors }`, most compared first, never the rival's own figures), `benchmarks` (`{ figure, cohort, cohortProperties, cohortDevelopers, median }`, present only when the cohort is large enough and the median meets the gate) and `completeness`. Another developer's property, an unlisted one, an unknown one and a malformed id are all `404 property_not_found`. |
| `GET /api/v1/developer/export`             | Implemented (2026-09-26)   | Developer staff        | The same `window`, and optionally `property` (one of the developer's own ids; another's is `404`). A CSV file (`text/csv`, attachment): `window, data_through, property, figure, unit, split, split_value, status, value`. A withheld figure has status `not enough data` and an empty value. Rivals and nearby medians follow the figures. A cell starting `=`, `+`, `-`, `@`, tab or CR is written with a leading apostrophe. Over 10,000 rows it is `422` and must be narrowed with `property`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `POST /api/v1/developer/submissions`       | On hold (owner 2026-09-20) | Developer staff        | Creates a draft/submission; it cannot publish.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `PATCH /api/v1/developer/submissions/{id}` | On hold (owner 2026-09-20) | Owning developer staff | Updates an eligible draft or responds to requested changes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
